...
<p>网站：“易米融理财”（域名：www.cmibank.com）</p>//cmibank todo
...
<article>
    <ul>
        ...
        <table>
        	...
        	<tr>
        		<td>债权形成时间：</td>
        		<td><?php echo isset($info['buy_time']) ? $info['buy_time'] : 'XXXX'; ?></td>
        		<td>年化利率：</td>
...
产品名称：<?php echo isset($info['pname']) ? $info['pname'] : 'XXXX'; ?>
           <table border="1">
				...
				<tr>
					<td><?php echo isset($info['buytime']) ? date('Y-m-d',$info['buytime']) : 'YYYY-MM-DD'; ?></td>
...
<p>日期：2015-05-13</p>
			...
			<div style="position:relative;">
				<p>
					...
					<img style="position:absolute;left:2rem;top:-2rem;" height="150" width="150" src="./用户购买协议_files/0420.172845.jcc_seal1.png">
				</p>
