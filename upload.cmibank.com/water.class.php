...
class water{
	...
	public function waterInfo($ground,$water,$pos=0,$prefix="lee_"){
		...
		//判断水印图片是否比原图大
                $newPos=$this->imgPos($groundInfo,$waterInfo,$pos);
...
//		}
	...
	public function saveImg($img,$ground,$info,$prefix){
	...
	public function imgCopy($ground,$water,$pos,$waterInfo){
	...
	public function imgRes($img,$imgType){
		switch($imgType){
			case "image/jpg":
			case "image/jpeg":
			case "image/pjpeg":
	...
	// 7 左下 8中下 9右下
	// 0 随机位置
	public function imgPos($ground,$water,$pos){
