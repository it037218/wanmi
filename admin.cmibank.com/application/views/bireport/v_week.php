<form id="pagerForm" method="post" action="<?php echo OP_DOMAIN; ?>/bireport/week">
	...
	<table class="list" width="100%" layoutH="55">
        <thead>
            <tr>
                ...
                <th width="3%">激活数</th>
                <th width="3%">注册数</th>
                <th width='4%'>本周新增绑卡用户</th>
                <th width='4%'>本周新增交易用户</th>
                <th width="4%">注册激活</th>
                <th width="4%">本周新增交易</th>
                <th width="4%">老用户转化交易人数</th>
                <th width="4%">老用户转化交易</th>
                <th width="4%">新增交易汇总</th>
                <th width="4%">本周新增交易/注册</th>
                <th width="4%">本周新增交易/绑卡</th>
                <th width="4%">本周新增绑卡/注册</th>
                <th width="4%">新用户新增交易金额</th>
                <th width="4%">老用户转化交易金额</th>
                <th width="4%">本周购买用户数</th> 
                <th width="5%">本周定期交易金额</th>
                <th width="5%">本周活期交易金额</th>     
                <th width="5%">本周总交易金额</th>
                <th width="4%">本周申购笔数</th>
                <th width="4%">ARPU</th>
                <th width="3%">复购率</th>
                <th width="3%">留存率</th>
            </tr>
