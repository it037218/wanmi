<form id="pagerForm" method="post" action="<?php echo OP_DOMAIN;?>/remit/no_remit">
...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            <form onsubmit="return navTabSearch(this);" action="<?php echo OP_DOMAIN; ?>remit/no_remit" method="post">
        ...
        <?php if(!empty($list)):?>
            <?php foreach($list AS $key => $value):?>
                ...
                <td>
				    ...
				    <?php }else{?>
				        <a href="<?php echo OP_DOMAIN?>/remit/editremit/<?php echo $value['pid'];?>" target="navtab" title="编辑打款凭条">
				                              编辑打款凭条
				        </a>
				    <?php }?>
				    <?php }?>
