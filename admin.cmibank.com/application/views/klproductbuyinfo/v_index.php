<form id="pagerForm" method="post" action="<?php echo OP_DOMAIN; ?>/klproductbuyinfo">
...
<div class="pageContent">
	<div class="panelBar">
        <ul class="toolBar">
            <form onsubmit="return navTabSearch(this);" action="<?php echo OP_DOMAIN?>/klproductbuyinfo" method="post">
	...
	<table class="list" width="100%" layoutH="55">
        ...
        <?php if(!empty($list)):?>
            ...
            <tr>
               ...
               <td><?php 
                   ...
                   ?></td>
               <td>
                <a href="<?php echo OP_DOMAIN?>/klproductbuyinfo/getklproductbuyinfoBypid/<?php echo $value['pid']?>" target="navtab" title="购买用户详情">查看</a>
               </td>
		...
		<?php endif;?>
		<tr>
		<?php if(!empty($rtnklmoney)){?>
		  <td>累计活期已售金额：</td>
		  <td><?php echo number_format($rtnklmoney)?></td>
		<?php }?>
		</tr>
		</tbody>
	</table>
