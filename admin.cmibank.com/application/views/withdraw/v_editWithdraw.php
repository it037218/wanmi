...
<div class="pageContent">
    <form method="post" action="<?php echo OP_DOMAIN;?>withdraw/editWithdraw" class="pageForm required-validate" onsubmit="return validateCallback(this,closedialog)">
        ...
        <div class="formBar">
            <ul>
                <input type="hidden" name="op" value="editWithdraw" />
