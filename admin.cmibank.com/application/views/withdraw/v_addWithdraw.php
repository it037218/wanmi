...
<div class="pageContent">
    <form method="post" action="<?php echo OP_DOMAIN;?>withdraw/addWithdraw" class="pageForm required-validate" onsubmit="return validateCallback(this,closedialog)">
        <div class="pageFormContent nowrap" layoutH="97">
            <dl>
                <dt>电话号码：</dt>
                <dd>
                	<input type="text" class="phone required" name="account"/>
                </dd>
            </dl>	
            <dl>    
                <dt>取现金额：</dt>
                <dd>
                    <input type="text" class="number required" name="money" />
                </dd>
            </dl>
            <dl style="height: 150px;">
				...
				<dd>
				 <input id="service_image_Input" type="file" name="service_image_file"
                        ...
                        />
                    <input type="text" name="url" id="service_image" class="required" style="width: 400px;"/>
                    <a href='' id="_open_service_image" target="_blank"><img alt="图片预览" id="_show_service_image"  style="position: absolute;height:80px;width: 150px;right: 99px;top:76px;"/></a>
				</dd>
			</dl>
            <dl>    
                <dt>备注：</dt>
        ...
        <div class="formBar">
            <ul>
                <input type="hidden" name="op" value="addWithdraw" />
