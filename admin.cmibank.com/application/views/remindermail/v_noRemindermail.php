<form id="pagerForm" method="post" action="<?php echo OP_DOMAIN;?>remindermail/noRemindermail">
...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            <form onsubmit="return navTabSearch(this);" action="<?php echo OP_DOMAIN;?>remindermail/noRemindermail" method="post">
	...
	<table class="list" width="100%" layoutH="55">
		<thead>
			<tr>
				...
				<th width="5%">合同总金额</th>
				<th width="4%">业务方利率</th>
				<th width="5%">实际回款本金</th>
				<th width="5%">实际回款利息</th>
        ...
        <?php if(!empty($list)):?>
            ...
            ?> 
            <?php if(strtotime($value['repaymenttime'])+86400*6<time()){?>
            	<tr style="color:red">
            <?php }else{?>
				<tr>
            <?php }?>
