<form id="pagerForm" method="post" action="<?php echo OP_DOMAIN;?>remindermail/alreadyRemindermail">
...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            <form onsubmit="return navTabSearch(this);" action="<?php echo OP_DOMAIN;?>remindermail/alreadyRemindermail" method="post">
        ...
        <?php if(!empty($list)):?>
            ...
            <?php 
                ...
                if(!empty($value['remittime'])){
                	...
                	$stocklixi=empty($value['stockmoney'])?'0':round($remitdays*$value['stockmoney']*$longProductIncome/36500,2);
                }
            ?> 
			<tr>
