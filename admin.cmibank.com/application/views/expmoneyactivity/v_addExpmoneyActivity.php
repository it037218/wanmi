...
<div class="pageContent">
    <form method="post" action="<?php echo OP_DOMAIN;?>expmoneyactivity/addExpmoneyActivity" class="pageForm required-validate" onsubmit="return validateCallback(this,closedialog)">
        <div class="pageFormContent nowrap" layoutH="97">
            ...
            <dl>    
             ...
             <dl>    
                <dt>体验金名称：</dt>
                <dd>
                    <input type="text" class="filed-text required" name="expname" id="id_expname" />
                </dd>
            </dl>
            <dl>    
                <dt>体验金金额：</dt>
                <dd>
                    <input type="text" class="digits" name="money" id="id_money" />
                </dd>
            </dl>
            <dl>    
                <dt>活动时间：</dt>
        ...
        <div class="formBar">
            <ul>
                <input type="hidden" name="op" value="addexpmoneyactivity"/>
