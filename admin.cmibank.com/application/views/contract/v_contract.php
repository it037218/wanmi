...
<!--                        <input type="text" class="filed-text required" readonly=true name="corname" id="corname" value="--><?php //echo $detail['corname'];?><!--"/>-->
                ...
                <dl>
                 ...
                 <dl>
                    <dt>保证金比例:</dt>
                    <dd>
                        <input type="text" class="filed-text required" name="con_bzjbl"  id="con_bzjbl" value="<?php echo $detail['con_bzjbl'];?>"  readonly="readonly"/>%
                    </dd>
                </dl>
                <dl>
                    <dt>用户合同模板:</dt>
                ...
                <dl>
                    <dt>债权利率:</dt>
                    <dd>
                        <input type="text" class="filed-text required" name="con_income"  value="<?php echo $detail['con_income'];?>" readonly="readonly"/>%
                    </dd>
                </dl>
                <dl>
                    <dt>合同期限</dt>
