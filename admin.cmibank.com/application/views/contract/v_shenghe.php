...
<div class="pageContent">
    <form method="post" action="<?php echo OP_DOMAIN;?>contract/shenghe" class="pageForm required-validate" onsubmit="return validateCallback(this,navTabAjaxDone)">
...
<!--                        <input type="text" class="filed-text required" readonly=true name="corname" id="corname" value="--><?php //echo $detail['corname'];?><!--"/>-->
        ...
        <div class="formBar">
            <ul>
                ...
                <input type="hidden" name="op" value="shenghe" />
