			...
			<dl style="height: 150px;">
				...
				<dd>
				 <input id="service_image_Input" type="file" name="service_image_file"
                        ...
                        />
                    <input type="text" name="returnbzjimg" id="service_image" value="<?php echo $returnbzjimg;?>" class="required" style="width: 400px;"/>
                    <a href='<?php echo $returnbzjimg;?>' id="_open_service_image" target="_blank"><img alt="图片预览" id="_show_service_image" src="<?php echo $returnbzjimg;?>" style="position: absolute;height:80px;width: 150px;right: 99px;top:76px;"/></a>
				</dd>
			</dl>
		</div>
		<div class="formBar">
