<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="<?php echo OP_DOMAIN?>redbag/getListByAccount" method="post">
	<div class="searchBar">
		<table class="searchContent">
			<tr>
				<td>
					手机号码：<input name="account" id="account" value="<?php echo isset($account)?$account:''?>"/>
				</td>
