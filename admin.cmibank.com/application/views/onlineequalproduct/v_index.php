            ...
            ?>
                ...
                <td>
                    <?php if($value['type'] == 'changping'){?>
                      <?php if($current_pid != '--'){?>
                        <a href="<?php echo OP_DOMAIN;?>equalproduct/detail?&pid=<?php echo $current_pid;?>" target="navtab" title="查看">查看</a>
                            <?php if($nextpname != '--'){?>
                                 &nbsp;&nbsp;|&nbsp;&nbsp;
                                <a href="<?php echo OP_DOMAIN;?>onlineequalproduct/changeindex?ptid=<?php echo $value['ptid']?>&odate=<?php echo $odate; ?>" target="navtab" title="上线产品调序">调序</a>
                            <?php }?> 
                        &nbsp;&nbsp;|&nbsp;&nbsp;
                        <a href="<?php echo OP_DOMAIN;?>onlineequalproduct/Soldout/<?php echo $value['ptid']?>/<?php echo $current_pid;?>/<?php echo $odate?>" target="ajaxTodo"  title="售罄" title="真的售罄了么？">售罄</a>
                        &nbsp;&nbsp;|&nbsp;&nbsp;
                    ...
                    <?php }else{?>
                        <?php if($current_pid != '--'){?>
                            <a href="<?php echo OP_DOMAIN;?>equalproduct/detail?&pid=<?php echo $current_pid;?>" target="navtab" title="查看">查看</a>
                                <?php if($nextpname != '--'){?>
                                &nbsp;&nbsp;|&nbsp;&nbsp;
                                <a href="<?php echo OP_DOMAIN;?>onlineequalproduct/yugao?ptid=<?php echo $value['ptid']?>&odate=<?php echo $odate; ?>" target="navtab" title="预告产品">调序</a>
                                <?php }?> 
                            &nbsp;&nbsp;|&nbsp;&nbsp;
                            <a href="<?php echo OP_DOMAIN;?>equalproduct/delequalproduct/<?php echo $current_pid?>" target="ajaxTodo" title="您真的要删除吗?">删除</a>	
    					 <?php }?>  
					<?php }?>
                </td>
                </tr>
