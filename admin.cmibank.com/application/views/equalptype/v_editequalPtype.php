<div class="pageContent">
    <form method="post" action="<?php echo OP_DOMAIN;?>equalptype/editequalptype" class="pageForm required-validate" onsubmit="return validateCallback(this,navTabAjaxDone)">
