<form id="pagerForm" method="post" action="<?php echo OP_DOMAIN; ?>repayment/repaymented">
...
<div class="pageContent">
    <div class="panelBar">
            <ul class="toolBar">
                <form onsubmit="return navTabSearch(this);" action="<?php echo OP_DOMAIN; ?>repayment/repaymented" method="post">
            ...
            <?php switch ($value['status']){
                ...
                <?php }else{?>
                    <?php if($value['repayment_status'] == 0){?>
                    	<?php if($editable==1){?>
                        <a href="<?php echo OP_DOMAIN;?>repayment/shenghe/<?php echo $value['pid']?>" target="ajaxtodo" >审核通过</a>
                        &nbsp;&nbsp;|&nbsp;&nbsp;
                        <?php }?>
