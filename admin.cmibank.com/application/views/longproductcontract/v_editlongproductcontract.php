...
<div class="pageContent">
    <form method="post" action="<?php echo OP_DOMAIN;?>longproductcontract/editLongproductcontract" class="pageForm required-validate" onsubmit="return validateCallback(this,navTabAjaxDone)">
        <div class="pageFormContent nowrap" layoutH="57">
            <fieldset class="EditField"><legend>基本信息</legend>
                <dl>
                    <dt>公司名称</dt>
                    <dd>
                        <input type="text" class="filed-text required " name="corname" id="corname" value="<?php echo $detail['corname'];?>"/>
                    </dd>
                </dl>
                <dl>
                    <dt>预期收益</dt>
                    <dd>
                        <input type="text" class="filed-text required " min="1" name="income" id="income" value="<?php echo $detail['income'];?>"/><span class="info">请输入一个大于1的数值</span>
                    </dd>
                </dl>
            </fieldset>
        ...
        <div class="formBar">
            <ul>
                ...
                <input type="hidden" name="op" value="editlongproductcontract" />
