...
<div class="pageContent">
    <form method="post" action="<?php echo OP_DOMAIN;?>longproductcontract/addLongproductcontract" class="pageForm required-validate" onsubmit="return validateCallback(this,navTabAjaxDone)">
        ...
        <div class="formBar">
            <ul>
                ...
                <input type="hidden" name="op" value="addlongproductcontract" />
