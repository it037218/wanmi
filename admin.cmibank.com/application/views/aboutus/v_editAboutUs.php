...
<div class="pageContent">
	<form method="post" action="<?php echo OP_DOMAIN?>aboutus/editAboutus" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
		<div class="pageFormContent" layoutH="56">
			...
			<dl>
				<dt>信息内容</dt>
				<dd><textarea name="content" class="required" cols="40" rows="4"><?php echo $detail['content'];?></textarea></dd>
			</dl>		
		</div>
		<div class="formBar">
			<ul>
