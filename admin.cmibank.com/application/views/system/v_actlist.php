...
<link type="text/css" href="<?php echo STATIC_DOMAIN;?>common/datapiker/css/ui-lightness/jquery-ui-1.8.18.custom.css" rel="stylesheet" />	
<title>长江活动</title>
		...
		<div id="main_container">
			<div class="container">
				<div id="search" style="padding-top:10px;padding-left:45px;">
					活动搜索:&nbsp;&nbsp;<input name="search_keyword" id="search_keyword" value="" style="height:25px;"/>&nbsp;&nbsp;<input type="button" value="搜索" id="search_submit" />
				</div>
				<div class="record" >
					<div id="datalist">
						数据获取中...
			...
			<div class="container hidden">
				<div class="record" >
					<div id="datalist">
						...
						<table class="table1">
							<tr>
								<td width=150px height=50px>活动标题:</td>
								<td width=700px align="left" class="tdleft"><input type="text" name="title" id="title" style="width:400px;height:25px;margin-left:20px;" />&nbsp;<span></span><span></span></td>
							</tr>
							<tr>
								<td width=150px height=50px>活动图片:</td>
								<td width=700px align="left" class="tdleft">
									...
									<img name="titlepic_skan" id="titlepic_skan" alt="图片预览" src="" width="80px" height="60px;"/>
									<span></span> 
								</td>
							</tr>
							<tr>
								<td width=150px height=50px>起始时间:</td>
								<td width=700px align="left" class="tdleft"><input type="text" name="starttime" id="starttime" style="width:227px;height:25px;margin-left:20px;" />&nbsp;<span></span></td>
							</tr>
							<tr>
								<td width=150px height=50px>结束时间:</td>
								<td width=700px align="left" class="tdleft"><input type="text" name="endtime" id="endtime" style="width:227px;height:25px;margin-left:20px;" />&nbsp;<span></span><span></span></td>
							</tr>
							<tr>
								<td width=150px height=50px>活动地点:</td>
								<td width=700px align="left" class="tdleft"><input type="text" name="address" id="address" style="width:400px;height:25px;margin-left:20px;" />&nbsp;<span></span><span></span></td>
							</tr>
							<tr>
								<td width=150px height=50px>活动内容:</td>
								<td width=700px align="left" class="tdleft">
									<textarea name="content" id="content" style="height:500px;width:600px;margin-left:20px;" rows=12></textarea>&nbsp;<span></span>
								</td>						
							</tr>
							<tr>
						...
						<input type="hidden" value="" name="titlepic" id="titlepic" />
						<input type="hidden" value="<?php echo $hidden['type'];?>" name="type" />
						</form>
					</div>
				</div>
			</div>
...
<script type="text/javascript" src="<?php echo STATIC_DOMAIN;?>common/datapiker/js/jquery-ui-1.8.18.custom.min.js"></script>
<script language="javascript" src="<?php echo STATIC_DOMAIN;?>common/js/ajaxfileupload.js"></script>
<script language="javascript" src="<?php echo STATIC_DOMAIN;?>common/js/jquery.validate.js"></script>
