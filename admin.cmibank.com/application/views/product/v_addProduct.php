...
<div class="pageContent">
    <form id='pageform' method="post" action="<?php echo OP_DOMAIN;?>product/addproduct" class="pageForm required-validate" onsubmit="return validateCallback(this,navTabAjaxDone)">
        <div class="pageFormContent nowrap" layoutH="97">
            ...
            <fieldset class="EditField"><legend>合同信息</legend>
                <dl>
                    <dt>债权公司:</dt>
                    <dd >
                        <select class="combox required" name="corcid" id="corcid" ref="classid_group" refUrl="<?php echo OP_DOMAIN; ?>/contract/getContractByCorid/{value}">
                ...
                <dl>    
                    <dt>业务类型：</dt>
    			    <dd>
                        <select class="required" name="ucid_select" id="ucid_select" disabled="disabled">
                            <option value="0" selected="" >请选择</option>
                ...
                <dl>
                    <dt>合同期限:</dt>
                    <dd >
                        <input type="text" class="filed-text" name="interesttime" id="interesttime" readonly="readonly"/>
                        <span class="info">&nbsp;&nbsp;至&nbsp;&nbsp;</span>
                        <input type="text" class="filed-text" name="repaymenttime" id="repaymenttime" readonly="readonly"/>
                    </dd>
                </dl>
            </fieldset>
            ...
            <fieldset class="EditField"><legend>基本信息</legend>
                ...
                <dl>
                    <dt>用户起息日</dt>
                    <dd>
                        <input type="text" class="date required" name="uistime" id="uistime" mindate="<?php echo $mindate?>" onblur="count_u_diff_day()"/>
                        <span class="info">&nbsp;&nbsp;至&nbsp;&nbsp;</span>
                        <input type="text" class="date required" name="uietime"  id="uietime" mindate="<?php echo $mindate?>" onblur="count_c_diff_day()"/>
                ...
                <dl>
                    <dt>合作方起息日</dt>
                    <dd>
                        <input type="text" class="date required" name="cistime" id="cistime" mindate="<?php echo $mindate?>" onblur="count_c_diff_day()"/>
                        <span class="info">&nbsp;&nbsp;至&nbsp;&nbsp;</span>
                        <input type="text" class="date required"  name="cietime" id="cietime" mindate="<?php echo $mindate?>" onblur="count_c_diff_day()"/>
                ...
                <dl>
                    ...
                    <dd>
                        <select name="repaymode" id="repaymode" class="combox">
                            <option value="1">到期偿还</option>
                           <!--   <option value="2">随存随取</option>-->
                        </select>  
                    </dd>
                </dl>
                <dl>
...
<!--                 </dl> -->
        ...
        <div class="formBar">
            <ul>
                ...
                <li><div class="buttonActive"><div class="buttonContent"><button type="button" onclick="validate();">提交</button></div></div></li>
...
<script type="text/javascript">
     ...
     function validate(){
    	...
    	if($uietime!=$repaymenttime){
    		alertMsg.error('产品结息时间与合同结息时间不一致');
    		return;
        }
    	if($cietime!=$repaymenttime){
    		alertMsg.error('合作方结息时间与合同结息时间不一致');
    		return;
        }
		$('#pageform').submit();
     }
     ...
     function cidchange(){
    	 ...
    	 $.ajax({
             ...
             success : function(data){
            	 ...
            	 $('#interesttime').val(data.interesttime);
            	 $('#repaymenttime').val(data.repaymenttime);
            	 $('#uietime').val(data.repaymenttime);
            	 $('#cietime').val(data.repaymenttime);
            	 $('#ucid_select').val(data.ucid);
            	 $('#ucid').val(data.ucid);
             }
         });
     }
