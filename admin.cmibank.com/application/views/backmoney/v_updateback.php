...
<div class="pageContent">
    <form method="post" action="<?php echo OP_DOMAIN;?>backmoney/updateback" class="pageForm required-validate" onsubmit="return validateCallback(this,navTabAjaxDone)">
			...
			<dl>
				...
				<dd>
				 <input id="warrant_img_Input" type="file" name="warrant_img_file"
                    ...
                    <a href='<?php echo $detail['warrant_img']?>' id="warrant_img12" target="_blank"><img alt="图片预览" id="show_warrant_img12" src="<?php echo $detail['warrant_img']?>" style="position: absolute;height: 60px;width: 60px;right: 150px;top:10px;"/></a>
				</dd>
			</dl>	
			</fieldset>
			...
			<dl style="height: 150px;">
				...
				<dd>
				 <input id="service_image_Input" type="file" name="service_image_file"
                    ...
                    <a href='' id="service_image12" target="_blank"><img alt="图片预览" id="show_service_image12" src="<?php echo $detail['service_image'];?>" style="position: absolute;height:80px;width: 150px;right: 99px;top:76px;"/></a>
				</dd>
			</dl>
			<dl>
				<dt>服务费备注</dt>
...
<script type="text/javascript">
	...
	$('.shadow').css('display','none');
     function uploadPicSuccess1(file, data, response){
         $('#show_warrant_img12').attr('src', data);
         $('#warrant_img').val(data);
         $('#warrant_img12').attr('href', data);
     }
     function uploadPicSuccess2(file, data, response){
         $('#show_service_image12').attr('src', data);
         $('#service_image').val(data);
         $('#service_image12').attr('href', data);
     }
