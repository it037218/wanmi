<form id="pagerForm" method="post" action="<?php echo OP_DOMAIN; ?>/backmoney/noback">
...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
           <form onsubmit="return navTabSearch(this);" action="<?php echo OP_DOMAIN; ?>/backmoney/noback" method="post">
	...
	<table class="list" width="100%" layoutH="55">
        ...
        <?php if(!empty($list)):?>
            ...
            <?php 
                ...
                $remitbenxi=0;$longmoneyProfit = 0;
