<form id="pagerForm" method="post" action="<?php echo OP_DOMAIN; ?>/backmoney/todayback">
...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
           <form onsubmit="return navTabSearch(this);" action="<?php echo OP_DOMAIN; ?>/backmoney/todayback" method="post">
	...
	<table class="list" width="100%" layoutH="55">
        ...
        <?php if(!empty($list)):?>
            ...
            <?php 
                ...
                if(!empty($value['remittime'])){
                    ...
                    if(strtotime($value['repaymenttime'])>strtotime('2017-07-12')){
                    	$longmoneyProfit = $remitdays*$value['stockmoney']*9/36500;
                    }
			...
			<tr target="sid_user" rel="1">
			    ...
			    <td><?php $remitservice =round($remitbenxi-$dingqibenxi-$value['stockmoney']-$longmoneyProfit,2); $total_service = $total_service+$remitservice; echo $remitservice;?></td>
