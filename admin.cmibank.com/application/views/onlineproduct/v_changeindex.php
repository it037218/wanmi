        ...
        <?php if(!empty($list)){?>
            <?php foreach($list AS $key=>$value){?>
                ...
                <?php if($count>=2){?>
				    ...
				    &nbsp;&nbsp;|&nbsp;&nbsp;
                    <a href="<?php echo OP_DOMAIN;?>onlineproduct/tiaoxu?action=up&pid=<?php echo $value['pid']; ?>&ptid=<?php echo $value['ptid'];?>&odate=<?php echo $odate; ?>" target="ajaxTodo" >上调</a>
                    &nbsp;&nbsp;|&nbsp;&nbsp;
                    <a href="<?php echo OP_DOMAIN;?>onlineproduct/tiaoxu?action=down&pid=<?php echo $value['pid']; ?>&ptid=<?php echo $value['ptid'];?>&odate=<?php echo $odate; ?>" target="ajaxTodo" >下调</a>
                    &nbsp;&nbsp;|&nbsp;&nbsp;
                    <a href="<?php echo OP_DOMAIN;?>onlineproduct/totop?pid=<?php echo $value['pid']; ?>&ptid=<?php echo $value['ptid'];?>&odate=<?php echo $odate; ?>" target="ajaxTodo" >置顶</a>
                    &nbsp;&nbsp;|&nbsp;&nbsp;
                    <a href="<?php echo OP_DOMAIN;?>onlineproduct/downtoline/<?php echo $value['ptid'];?>/<?php echo $value['pid'];?> " target="ajaxTodo" title="下架" title="您真的要下架吗?">下架</a>
                    &nbsp;&nbsp;|&nbsp;&nbsp;
