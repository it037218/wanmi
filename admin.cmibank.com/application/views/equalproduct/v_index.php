...
<div class="pageContent">
	...
	<div class="panelBar">
        <ul class="toolBar">
            ...
            <li style="display:<?php if($status==1){echo 'none';}else{echo 'black';}?>"><a title="添加产品"  href="<?php echo OP_DOMAIN; ?>equalproduct/addproduct" target="navtab"  class="icon"><span>添加产品</span></a></li>
        ...
        <?php if(!empty($list)):?>
            <?php foreach($list AS $key=>$value):?>
                ...
                <a href="<?php echo OP_DOMAIN;?>equalproduct/detail? &pid=<?php echo $value['pid'];?>" target="navtab" title="查看">查看</a>
                  <?php if(!$value['status']){?>
                        &nbsp;&nbsp;|&nbsp;&nbsp;
                        <a href="<?php echo OP_DOMAIN;?>equalproduct/editequalproduct/<?php echo $value['pid'];?>" target="navtab" title="编辑">基本编辑</a>
                        &nbsp;&nbsp;|&nbsp;&nbsp;
                        <a href="<?php echo OP_DOMAIN;?>equalproduct/uptoline/<?php echo $value['pid'];?>/<?php echo $value['ptid'];?>" target="dialog" title="发布上线" title="您真的要上线吗?">上线</a>
                        &nbsp;&nbsp;|&nbsp;&nbsp;
                        <a href="<?php echo OP_DOMAIN;?>equalproduct/delequalproduct/<?php echo $value['pid']?>" target="ajaxTodo" title="您真的要删除吗?">删除</a>
                  <?php }else{ ?>
                  &nbsp;&nbsp;|&nbsp;&nbsp;
                  <a href="<?php echo OP_DOMAIN;?>equalproduct/getProductBuyInfoByPid/<?php echo $value['pid'];?>" target="navtab" title="查看定期用户购买记录">查看购买记录</a>
<!--                         &nbsp;&nbsp;|&nbsp;&nbsp; -->
