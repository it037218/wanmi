<div class="pageContent">
    <form method="post" action="<?php echo OP_DOMAIN;?>equalproduct/uptoline" class="pageForm required-validate" onsubmit="return validateCallback(this,dialogAjaxDone)">
