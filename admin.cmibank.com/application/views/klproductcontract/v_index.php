<form id="pagerForm" method="post" action="<?php echo OP_DOMAIN; ?>/klproductcontract">
	...
	<table class="list" width="100%" layoutH="55">
        ...
        <?php if(!empty($list)):?>
            <?php foreach($list AS $key=>$value):?>
                ...
                <td>
                <a href="<?php echo OP_DOMAIN;?>klproductcontract/editKlproductcontract/<?php echo $value['cid'];?>" target="navtab" title="合同编辑">编辑</a>
                </td>
                </tr>
            <?php endforeach;?>
		<?php endif;?>
