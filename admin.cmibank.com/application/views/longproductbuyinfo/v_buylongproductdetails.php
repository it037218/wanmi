<form id="pagerForm" method="post" action="<?php echo OP_DOMAIN; ?>/longproductbuyinfo/getlongproductbuyinfoBypid/<?php echo $pid;?>">
...
<div class="pageContent">
	<div class="panelBar">
        <ul class="toolBar">
            <form onsubmit="return navTabSearch(this);" action="<?php echo OP_DOMAIN?>/longproductbuyinfo/getlongproductbuyinfoBypid" method="post">
