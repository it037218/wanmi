...
<div class="pageContent">
	<div class="panelBar" >
        <ul class="toolBar">
            <form onsubmit="return navTabSearch(this);" action="<?php echo OP_DOMAIN?>/longproductbuyinfo" method="post" style="display:<?php if($status==0){echo 'none';}else{echo 'black';}?>">
            ...
            <?php if($editable==1){?>
	            <li style="display:<?php if($status==1){echo 'none';}else{echo 'black';}?>"><a title="添加产品"    href="<?php echo OP_DOMAIN; ?>longproduct/addLongproduct" target="navtab"  class="icon"><span>添加产品</span></a></li>
	...
	<table class="list" width="100%" layoutH="55">
        ...
        <?php if(!empty($list)):?>
            ...
            <?php switch ($value['status']){
                ...
                <tr>
                <td><?php echo $ltype_list[$value['ptid']];?></td>
               ...
               ?></td>
                ...
                <a href="<?php echo OP_DOMAIN;?>longproduct/detail?&pid=<?php echo $value['pid'];?>" target="navtab" title="查看">查看</a>
                  <?php if(!$value['status']){?>
	                <?php if($editable==1){?>
                        &nbsp;&nbsp;|&nbsp;&nbsp;
                        <a href="<?php echo OP_DOMAIN;?>longproduct/uptoline/<?php echo $value['pid'];?>/<?php echo $value['ptid'];?>" target="dialog"  title="您真的要上线吗?">上线</a>
                        &nbsp;&nbsp;|&nbsp;&nbsp;
                        <a href="<?php echo OP_DOMAIN;?>longproduct/editLongproduct/<?php echo $value['pid'];?>/<?php echo $value['ptid'];?>" target="navtab" title="基本编辑">编辑</a>
                        &nbsp;&nbsp;|&nbsp;&nbsp;
                        <a href="<?php echo OP_DOMAIN;?>longproduct/delLongproduct/<?php echo $value['pid']?>" target="ajaxTodo" title="您真的要删除吗?">删除</a>
	                  <?php } ?>
                  <?php }else{ ?>
                  &nbsp;&nbsp;|&nbsp;&nbsp;
                  <a href="<?php echo OP_DOMAIN;?>longproductbuyinfo/getlongproductbuyinfoBypid/<?php echo $value['pid'];?>" target="navtab" title="查看活期用户购买记录">查看购买记录</a>
                       <!--   &nbsp;&nbsp;|&nbsp;&nbsp;
