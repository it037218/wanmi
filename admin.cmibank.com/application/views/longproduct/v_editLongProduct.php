...
<div class="pageContent">
    <form method="post" action="<?php echo OP_DOMAIN;?>longproduct/editLongproduct" class="pageForm required-validate" onsubmit="return validateCallback(this,navTabAjaxDone)">
                ...
                <dl>
                    ...
                    <dd style="width:13%">
                        <select class="combox" id="classid_group" name="cid" onchange='ltidchange()'>
                            ...
                            <?php print_r('$longproductcontract_list');?>
                            <?php if(!empty($ltype_list)){ ?>
        ...
        <div class="formBar">
            <ul>
                 <input type="hidden" name="op" value="editLongproduct" />
