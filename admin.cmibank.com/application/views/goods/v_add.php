...
$(function() {
	$("input:radio[id='type_radio']").click( function () {
		if($(this).val()==2){
...
<div class="pageContent">
    <form method="post" action="<?php echo OP_DOMAIN;?>goods/addgoods" class="pageForm required-validate" onsubmit="return validateCallback(this,closedialog)">
        <div class="pageFormContent nowrap" layoutH="97">
            ...
            <dl>    
                <dt>销售价格：</dt>
                <dd>
                    <input type="text" class="required digits" name="jifeng"/>
                </dd>
            </dl>
            <dl>    
                <dt>原始价格：</dt>
                <dd>
                    <input type="text" class="required digits" name="yuanjifeng"/>
                </dd>
            </dl>
             <dl>    
                <dt>库存：</dt>
                <dd>
                    <input type="text" class="required digits" name="stock"/>
                </dd>
            </dl>
            <dl>    
                <dt>商品类型：</dt>
                 <dd>
                    <table>
                    	<tr style="height: 25px">
                    		<td><input name="type" type="radio" id="type_radio" style="float:left" value="1" checked/>体验金</td>
                    		<td><input name="type" type="radio" id="type_radio" style="float:left" value="2"/>抵用券</td>
                    	</tr>
                    	<tr style="height: 25px">
	                    	<td><input name="type" type="radio" id="type_radio" style="float:left" value="3"/>邀请红包</td>
	                    	<td><input name="type" type="radio" id="type_radio" style="float:left" value="4"/>实物</td>
                    	</tr>
                    </table>
                </dd>
            </dl>
            <dl id="coupondiv"  style="display: none">    
            	<dt>&nbsp&nbsp</dt>
	                	 ...
	                	 <?php if(!empty($couponList)){?>
	            			<?php foreach($couponList AS $key=>$value){?>
			                	<div style="height: 25px">
		                			<label style="width: 100%"><input type="radio" name="coupon_jifeng" value="<?php echo $value['id'] ;?>"/><?php echo $value['name'].'， '.$value['sendmoney'].'元，起购'.$value['minmoney'].'，适用于'.$value['pnames'];?></label>
			                	</div>
							<?php }?>
						<?php }?>
                 	</div>
            ...
            <dl>    
                <dt style="width:80px;">商品图片:</dt>
                    <dd style="width:13%">
                        ...
                        />
                    <input type="text" name="img" id="goods_img" value="http://static1.cmibank.com/images/icon_jifen_tyj.png" class="filed-text" style="width: 300px;"/>
                    <img alt="图片预览" id="_show_goods" src="http://static1.cmibank.com/images/icon_jifen_tyj.png" style="position: absolute;height: 30px;width: 30px;right: 150px;top:10px;"/>
                    </dd>
            </dl>
            <dl>    
                <dt>排序：</dt>
                <dd>
                    <input type="text" class="required" name="rank"/>
                </dd>
            </dl>
            <dl>
				<dt>商品描述:</dt>
                    <dd >
                        <textarea style="width:100%;height:50px" name="desc" id="desc"></textarea>
                    </dd>
                </dl>
        </div>
        <div class="formBar">
