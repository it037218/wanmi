...
class Featureredis {
    ...
    public function incrWithValue($id, $val) {
        return $this->_redis->incr($id, $val);
    }

    public function incrByFloat($id, $val) {
        return $this->_redis->incrByFloat($id, $val);
    }
	 ...
	 * @param $repeat int 判断value是否存在  0:不判断存在 1:判断存在 如果 当 key 不存在时
	 */
	...
	public function zRevRank($set, $value){
	    return $this->_redis->zRevRank($set, $value);
	}
	...
	public function setRevRangeBySorce($set,$start,$end)
	{
	    $return = null;
	    $return = $this->_redis->zRevRangeByScore($set, $start, $end);
	
	    return $return;
	}

	public function setRangeBySorce($set,$start,$end)
	{
	    $return = null;
	    $return = $this->_redis->zRangeByScore($set, $start, $end);
	...
	public function zSetDelete($set, $value){
	    $return = null;
	    $return = $this->_redis->zDelete($set, $value);
	    return $return;
	}
