 ...
 */
require_once (APPPATH . 'libraries/llpay/waplib/llpay_core.function.php');
require_once (APPPATH . 'libraries/llpay/waplib/llpay_md5.function.php');
require_once (APPPATH . 'libraries/llpay/waplib/llpay_rsa.function.php');

class WAPLLpaySubmit {
	...
	function WAPLLpaySubmit($llpay_config) {
