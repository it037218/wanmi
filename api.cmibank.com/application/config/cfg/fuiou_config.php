...
if (php_sapi_name() == 'cli') {
    ...
    if (@$_SERVER['ENVIRONMENT'] == 'production') {
        $config = array(
            ...
            'pay_notify_url' => 'http://api.cmibank.com/fuioupay_back/payNotify',
            //绑卡参数
            'mchntcd' => '0002900F0504406',
            'mchnt_key' => '5f0bx65hzecaduuib7ckfidy17ck4fa2',
            'url' => 'https://mpay.fuiou.com:16128/checkCard/checkCardDebit.pay',
            'mver' => '1.30',
        );
        ...
        $config = array(
            ...
            'mchnt_key' => '5old71wihg2tqjug9kkpxnhx9hiujoqj',
            'url' => 'http://www-1.fuiou.com:18670/mobile_pay/checkCard/checkCardDebit.pay',
            'mver' => '1.30',
        );
    }
}
