...
<body>
	...
	<div style="margin: 20px 0px 20px 0px;">
		<table id="half">
			<tr><td colspan="2">甲方(出让方):</td></tr>
			<tr><td colspan="2">身份证号/营业执照号: </td></tr>
			<tr><td colspan="2">乙方(受让方): </td></tr>
			...
			<tr><td colspan="2">地址:浦东新区杨新路88号  骊湾88文化创意产业园3号楼201室</td></tr>
			<tr><td>法人代表：陈育峰 </td><td>电话：4008719299</td></tr>
		</table>
		<p>
	...
	<div style="margin-bottom: 20px;">
		<table id="nohalf">
			<tr>
				<td colspan="3" style="border:0; text-align: left;">1、 产品名称: </td>
			</tr>
			<tr>
	...
	<div style="margin-bottom: 20px;">
		...
		<br /><br />
		2、债权回购日为  ，根据甲丙直接签订的《债权委托转让协议》( )，
		甲方将债权本金和期望总收益支付至丙方在第三方支付平台开具的托管账户，丙方应当于收到上述款项后的三个工作日内向乙方支付债权本金和收益，
		乙方的债权因受偿而得到实现。若甲方无力履行回购义务，则根据《债权委托转让协议》(编号： )约定，丙方有
		权以甲方的还款保证金先行垫付给乙方，并要求相关担保方 及担保人 对甲方的回购
	...
	<div style="margin-bottom: 20px;">
		...
		<br />
		<span class="img_fixed">法人代表（或者全权代表）(签章）：</span>
		<br />
		日期： 
	</div>
	</body>
