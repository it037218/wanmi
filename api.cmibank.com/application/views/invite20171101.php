...
<body>
<div class="head"><img  src="<?php echo $static_domain; ?>/images/yaoqing20171101.png?timestamp=<?php echo time(); ?>" width="100%"/></div>
<div class="login" id="login1" style="background: #50CEB6">
...
<div class="login" id="login2" style="display:none;background:#50CEB6">
	<p style="color: white">我正在易米融理财抢现金，你也来领取吧！</br></p>
	<ul>
...
<div style="background: #50CEB6;">
<div class="shuoming"><img  src="<?php echo $static_domain; ?>/images/yaoqing20171101_2.png?timestamp=<?php echo time(); ?>" width="100%" />
