...
class equalproduct_buy_info_base extends Basemodel{

    private $_table = 'cmibank.cmibank_equalproduct_buy_info_';
    ...
    public function addEqualProductBuyInfo($pid, $data){
        $_table_index = $pid % 16;
        $table = $this->_table . $_table_index;
        $data['ctime'] = NOW;
    ...
    public function updateEqualProductBuyInfo($data, $where){
